info.innerHTML =
`<h3>💡Você Sabia?</h3><br>
<p><i>De acordo com a Organização Mundial de Saúde (OMS), cerca de <b> 50% </b> das vacinas produzidas, em todo o mundo, chegam ao seu destino em condições precárias e
...
medicamentos. O descumprimento das disposições constitui infração sanitária, levando à <b>multa</b>!<i></p>
`
...
resolucao.innerHTML =
`<p>Você está perdendo aproximadamente <b style=color:red>${vacinaTotalAno}</b> doses de vacinas por ano! Ou seja, <b style=color:red>R$${dinheiroPerdido}</b> por ano!</p><br>
